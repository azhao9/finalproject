...
def main():
  ...
  #noisy_image = read_image_and_binarize(sys.argv[3])
  ...
  convert_from_matrix_and_save(orig_image, 'bin_orig_imgs/'+noise_type+'/'+fname, display=False)
  convert_from_matrix_and_save(noisy_image, 'bin_noisy_imgs/'+noise_type+'/'+fname, display=False)
  convert_from_matrix_and_save(denoised_image, 'bin_denoised_imgs/mrf/'+noise_type+'/'+fname, display=False)
